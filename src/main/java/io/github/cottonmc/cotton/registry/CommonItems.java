...
public class CommonItems {
	...
	/**Attempts to get a common item by name. If no item with this name was found register a new item, add it to the common item tab, and return it.
	...
	/**Attempts to get a common item by name. If no item with this name was found register a new item, add it to the specified tab,
	 * and return it.
	 * Only use this method if you are sure that you want to add the new block to a specific tag.
	 *
	 * @param name The item name to look for. This is the path and does not include the namespace.
	 * @param item A item that will be registered if no item with this namespace was found.
